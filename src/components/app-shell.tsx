...
const NAV_ITEMS = [
  ...
  { to: "/app/smm", label: "Grow Socials", icon: TrendingUp },
  ...
  return (
    <div className="min-h-screen bg-gradient-surface">
      ...
      <aside className="fixed inset-y-0 left-0 hidden w-64 border-r border-border bg-sidebar p-4 md:flex md:flex-col">
        <SidebarContent balance={balance} fmt={fmt} isAdmin={!!data?.isAdmin} onSignOut={signOut} />
      </aside>
  ...
  return (
    <>
      ...
      <div className="mt-4 rounded-xl border border-border bg-card p-3 shadow-soft">
        ...
        <Link to="/app/fund" onClick={onNavigate} className="text-xs text-primary hover:underline">
          + Add funds
        </Link>
      </div>
